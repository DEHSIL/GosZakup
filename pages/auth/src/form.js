document.addEventListener("DOMContentLoaded", function() {
    ...
    confirmBtn.addEventListener("click", () => {
        ...
        if (localStorage.getItem("userData")){
            window.location.href ="GosZakup/pages/auth/Вход второе подтверждение пароля/auth_confirm.html"
        } else {
            window.location.href ="GosZakup/pages/auth/Вход после ЭЦП/register.html"
        }
